            ...
            while (true)
            {
                ...
                if (packet.Length != 0)
                {
                    ...
                    try
                    {
                        ...
                        client.Port = 587;
                        client.Host = "SMTP_DOMAIN";
                        client.EnableSsl = true;

                        client.Timeout = 10000;
                        client.DeliveryMethod = SmtpDeliveryMethod.Network;
                        client.UseDefaultCredentials = false;
                        client.Credentials = new System.Net.NetworkCredential("SNMP_UN", "SNMP_PW");


                        MailMessage mm = new MailMessage("EMAIL_FROM@GMAIL.COM", "EMAIL_TO@GMAIL.COM", SNMPSubject, SNMPBody);
