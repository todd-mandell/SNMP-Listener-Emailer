...
namespace OpenITTools_SNMP_Listener_Emailer
{
    ...
    {  
        static void Main(string[] args)
        {
            ...
            //done to allow reuse of the socket 
            listener = new UdpClient(port);
                ...
                if (packet.Length != 0)
                {
                    ...
                    if (packet[0] == 0xff)
                    {
                        ...
                        try
                        {
                            ...
                            client.Port = 587;
                            client.Host = "SnmpHostURI";
                            client.EnableSsl = true;

                            client.Timeout = 10000;
                            client.DeliveryMethod = SmtpDeliveryMethod.Network;
                            client.UseDefaultCredentials = false;
                            client.Credentials = new System.Net.NetworkCredential("SnmpUser", "SnmpPassword");

                            MailMessage mm = new MailMessage("emailFrom", "emailTo", SNMPSubject, SNMPBody);
